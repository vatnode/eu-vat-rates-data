...
VAT_FORMATS: dict[str, str] = {
    ...
    "DK": "DK + 8 digits",
    "EE": "EE + 9 digits",
    "ES": "ES + letter + 7 digits + letter/digit, or ES + 8 digits + letter",
    "FI": "FI + 8 digits",
    ...
    "HR": "HR + 11 digits",
    "HU": "HU + 8 digits",
    "IE": "IE + 7 digits + 1–2 letters, or IE + 1 digit + letter/+/* + 5 digits + 1 letter",
    "IS": "5–6 digits",
    "IT": "IT + 11 digits",
    "LI": "5 digits",
...
VAT_PATTERNS: dict[str, Optional[str]] = {
    ...
    "DK": r"^DK\d{8}$",
    "EE": r"^EE\d{9}$",
    "ES": r"^ES([A-Z]\d{7}[A-Z0-9]|\d{8}[A-Z])$",
    "FI": r"^FI\d{8}$",
    ...
    "HR": r"^HR\d{11}$",
    "HU": r"^HU\d{8}$",
    "IE": r"^IE\d{7}[A-W][AH]?$|^IE\d[A-Z+*]\d{5}[A-W]$",
    "IS": r"^\d{5,6}$",
    "IT": r"^IT\d{11}$",
    "LI": r"^\d{5}$",
    "LT": r"^LT(\d{9}|\d{12})$",
